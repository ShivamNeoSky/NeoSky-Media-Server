 ...
 show_usage()
{
	...
	echo "-----"
	echo
	echo "  SERVER_URL=https://localhost:4443 ROOM_ID=fnqwafi5 MEDIA_FILE=./test.mp4 ./gstreamer.sh"
	echo
	echo "  where:"
...
# 	>&2 echo "${SERVER_URL}ERROR: missing SERVER_URL environment variable"
# 	show_usage
# 	exit 1
# fi
